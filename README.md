...
对任何支持 SKILL.md 标准的 agent(Claude Code / Codex / Hermes / OpenClaw…)说一句:

> "克隆 https://github.com/xinzhuwang-wxz/video-engine 并按它的 AGENT.md 装好"

它会自己跑 `setup.sh`、读操作手册、把技能挂进自己的技能目录。提示词示例:[`PROMPT_GALLERY.md`](PROMPT_GALLERY.md)
